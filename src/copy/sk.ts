...
export const TITLE_LOCKUP = 'OČISTEC THE GAME'

export const TAGLINE = 'STAŇ SA LEGENDOU. ALEBO SA NECHAJ ODHALIŤ.'

export const START_GAME = 'ZAČAŤ HRU'

export const SETTINGS = 'NASTAVENIA'

export const LEADERBOARDS = 'REBRÍČKY'
...
export const KONTROLA_SUBTITLE = 'Prišla kontrola z ministerstva vnútra!'
export const YOUR_RISK = 'Tvoje riziko:'
export const KONTROLA_RESULT = 'VÝSLEDOK KONTROLY'
export const FINALE_SUBTITLE = 'Tvoja kauza ide pred súd.'
export const FINAL_RISK = 'Tvoje konečné riziko:'
export const SWIPE_HINT = '← SWIPE PRE ROZHODNUTIE →'
export const HOW_TO_LOWER_RISK = 'AKO ZNÍŽIŤ RIZIKO?'
export const RISK_EXPLAINER = 'Čím vyššie riziko, tým väčšia šanca, že ťa odhalia pri kontrole.'
export const ACTIVE_BONUSES = 'AKTÍVNE BONUSY'
export const YOUR_MONEY = 'TVOJE PENIAZE:'
export const QUICK_COVER_TITLE = 'RÝCHLE KRYTIE'
export const USE = 'POUŽIŤ'
export const CAREER_TITLE = 'KARIÉRA'
export const BOSS = 'ŠÉF'
export const LEVEL = 'ÚROVEŇ'
